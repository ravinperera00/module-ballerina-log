...
//    validateLog(logLines[11], "INFO", "[logorg/foo]", "Logging from inside `foo` module");
//    validateLog(logLines[12], "INFO", "[logorg/bar]", "Logging from inside `bar` module");
//    validateLog(logLines[13], "ERROR", "[logorg/baz]", "Logging at ERROR level inside `baz`");
//    validateLog(logLines[14], "INFO", "[logorg/mainmod]", "Logging from inside `mainmod` module");
//}
...
public function testErrorMessage() {
    ...
    test:assertEquals(logLines.length(), 11, INCORRECT_NUMBER_OF_LINES);
    validateLog(logLines[6], "ERROR", "[]", ERROR_LOG);
    validateLog(logLines[7], "ERROR", "[]", INTEGER_OUTPUT);
    validateLog(logLines[8], "ERROR", "[]", FLOAT_OUTPUT);
    validateLog(logLines[9], "ERROR", "[]", BOOLEAN_OUTPUT);
    validateLog(logLines[10], "ERROR", "[]", FUNCTION_OUTPUT);
}
...
public function testWarnMessage() {
    ...
    validateLog(logLines[7], "WARN", "[]", INTEGER_OUTPUT);
    validateLog(logLines[8], "WARN", "[]", FLOAT_OUTPUT);
    validateLog(logLines[9], "WARN", "[]", BOOLEAN_OUTPUT);
    validateLog(logLines[10], "WARN", "[]", FUNCTION_OUTPUT);
}
...
public function testInfoMessage() {
    ...
    validateLog(logLines[7], "INFO", "[]", INTEGER_OUTPUT);
    validateLog(logLines[8], "INFO", "[]", FLOAT_OUTPUT);
    validateLog(logLines[9], "INFO", "[]", BOOLEAN_OUTPUT);
    validateLog(logLines[10], "INFO", "[]", FUNCTION_OUTPUT);
}
...
public function testDebugMessage() {
    ...
    string[] logLines = stringutils:split(outText, "\n");
    test:assertEquals(logLines.length(), 11, INCORRECT_NUMBER_OF_LINES);
    validateLog(logLines[6], "DEBUG", "[]", DEBUG_LOG);
    validateLog(logLines[7], "DEBUG", "[]", INTEGER_OUTPUT);
    validateLog(logLines[8], "DEBUG", "[]", FLOAT_OUTPUT);
    validateLog(logLines[9], "DEBUG", "[]", BOOLEAN_OUTPUT);
    validateLog(logLines[10], "DEBUG", "[]", FUNCTION_OUTPUT);
}
...
public function testTraceMessage() {
    ...
    string[] logLines = stringutils:split(outText, "\n");
    test:assertEquals(logLines.length(), 11, INCORRECT_NUMBER_OF_LINES);
    validateLog(logLines[6], "TRACE", "[]", TRACE_LOG);
    validateLog(logLines[7], "TRACE", "[]", INTEGER_OUTPUT);
    validateLog(logLines[8], "TRACE", "[]", FLOAT_OUTPUT);
    validateLog(logLines[9], "TRACE", "[]", BOOLEAN_OUTPUT);
    validateLog(logLines[10], "TRACE", "[]", FUNCTION_OUTPUT);
}
